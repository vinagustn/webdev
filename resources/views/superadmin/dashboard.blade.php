            ...
            <div class="card" style="border: 1px solid; background: #1F6E8C">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <svg style="opacity: 40%; color:white" width="70px" viewBox="0 0 512 512"
                ...
                <button class="card-footer" style="color: white; border-bottom: none; border-right:none; border-left:none"
                    data-bs-target="#breeding" data-bs-toggle="collapse" aria-expanded="true">
            ...
            <div class="card bg-success" style="border: 1px solid">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <svg style="opacity: 40%" fill="white" version="1.1" id="Capa_1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="70px"viewBox="0 0 31.385 31.385" xml:space="preserve">
                                <g>
                                    <g>
                                        <path
                ...
                <button class="card-footer" style="color: white; border-bottom: none; border-right:none; border-left:none"
                    data-bs-target="#marriage" data-bs-toggle="collapse" aria-expanded="true">
                    View details <i class="bi bi-arrow-right"></i>
                </button>
            </div>
        </div>
            ...
            <div class="card" style="border: 1px solid; background: #FFA41B">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <svg style="opacity: 40%" fill="white" height="70px" version="1.1" id="Layer_1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                viewBox="0 0 512 512" xml:space="preserve">
                                <g>
                                    <g>
                                        <path
                                            d="M420.224,261.952c-10.731-6.741-23.936-7.467-35.328-1.984L352,275.797V256c11.797,0,21.333-9.557,21.333-21.333V192
                ...
                <button class="card-footer" style="color: white; border-bottom: none; border-right:none; border-left:none"
                    data-bs-target="#birth" data-bs-toggle="collapse" aria-expanded="false">
                    View details <i class="bi bi-arrow-right"></i>
                </button>
            </div>
        </div>
            ...
            <div class="card bg-danger" style="border: 1px solid">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <svg width="70px" style="opacity: 40%" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <button class="card-footer" style="color: white; border-bottom: none; border-right:none; border-left:none"
                    data-bs-target="#health" data-bs-toggle="collapse" aria-expanded="false">
                    View details <i class="bi bi-arrow-right"></i>
                </button>
            </div>
        </div>
