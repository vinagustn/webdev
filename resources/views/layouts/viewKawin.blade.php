        ...
        <div class="card-body">
            ...
            <div style="overflow-x: scroll">
                <table class="table table-hover">
                    ...
                    <tbody>
                        @php
                            $i = ($marriages->currentpage()-1)*$marriages->perpage()+1;
                        @endphp
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-1">
                                        <a href="/perkawinan/{{ $marriage->id }}/edit">
                                    ...
                                    <div class="col-1">
                                        <form method="POST" action="/perkawinan/list/{{ $marriage->id }}">
                                            @method('delete')
                                            @csrf
                                            <button class="badge text-danger border-0" onclick="return confirm('Yakin akan hapus data?')">
...
@section('search')
<form action="/perkawinan/list" class="d-flex me-3" role="search">
